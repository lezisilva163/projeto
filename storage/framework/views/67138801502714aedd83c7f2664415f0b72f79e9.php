...
<head>
  ...
  <!-- CSS Files -->
  <link href="<?php echo e(url('../assets/css/material-dashboard.css?v=2.1.1')); ?>" rel="stylesheet" />
...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="green" data-background-color="black" data-image="<?php echo e(url('../assets/img/futebol.jpg')); ?>">
      <!--
        ...
        <ul class="nav">
          <li class="nav-item active  ">
            <a class="nav-link" href="<?php echo e(url('/')); ?>">
              ...
              <p>Agendar horários</p>
            </a>
          </li>
          <li class="nav-item active  ">
            <a class="nav-link" href="<?php echo e(url('/cadastrar')); ?>">
              <i class="material-icons">dashboard</i>
              <p>Cadastrar clientes</p>
            </a>
          </li>
          <li class="nav-item active  ">
            <a class="nav-link" href="<?php echo e(url('/clients/store')); ?>">
              <i class="material-icons">dashboard</i>
  ...
  <script src="<?php echo e(url('../assets/js/core/bootstrap-material-design.min.js')); ?>"></script>
  ...
  <script src="<?php echo e(url('../assets/js/material-dashboard.js?v=2.1.1" type="text/javascript')); ?>"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="<?php echo e(url('../assets/demo/demo.js')); ?>"></script>
  <!-- datepicker -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/datepicker/0.6.5/datepicker.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/datepicker/0.6.5/i18n/datepicker.pt-BR.js"></script>
...
<?php /**PATH C:\laragon\www\Cancha\resources\views/dashboard.blade.php ENDPATH**/ ?>